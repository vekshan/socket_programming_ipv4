...
if(verify_checksum(msg) == True):
    ...
    ip = str(int(msg_list[6][:2],16)) + "." +str(int(msg_list[6][2:],16)) + "." + str(int(msg_list[7][:2],16)) + "." +str(int(msg_list[7][2:],16)) 
    ...
    '''.format(ip,payload,data_length_bit, data_length,str(total_length)))
else:
